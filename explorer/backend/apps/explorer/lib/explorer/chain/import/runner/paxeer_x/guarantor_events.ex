defmodule Explorer.Chain.Import.Runner.PaxeerX.GuarantorEvents do
  @moduledoc """
  ...
  @type imported :: [GuarantorEvent.t()]

  @impl Import.Runner
  def ecto_schema_module, do: GuarantorEvent

  @impl Import.Runner
  def option_key, do: :paxeer_x_guarantor_events
  ...
  def run(multi, changes_list, %{timestamps: timestamps} = options) do
    ...
    Multi.run(multi, :insert_paxeer_x_guarantor_events, fn repo, _ ->
