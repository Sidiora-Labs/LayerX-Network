...
/// # Errors
/// Refuses untrusted transport, invalid addresses and missing chain binding.
pub fn canonical_endpoint_identity(endpoint: &EndpointConfig) -> Result<String, EndpointFault> {
