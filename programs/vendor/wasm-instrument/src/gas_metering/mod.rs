...
pub fn inject<R: Rules, B: Backend>(
    ...
    for section in module.into_sections() {
        ...
        if matches!(
            section,
            elements::Section::Custom(_) | elements::Section::Name(_)
        ) {
