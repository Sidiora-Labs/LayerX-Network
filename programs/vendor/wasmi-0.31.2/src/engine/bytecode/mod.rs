...
pub enum Instruction {
    ...
    Unreachable,
    /// Marks the exact source WebAssembly operator boundary at `program_counter`.
    ///
    /// Unlike fuel-block instructions this is emitted once for every validated
    /// source operator and is never coalesced by translation.
    Observe(u64),
