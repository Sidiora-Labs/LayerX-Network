...
func createTestApp(t *testing.T, isCheckTx bool) (*paxapp.App, sdk.Context) {
	app := paxapp.Setup(t, isCheckTx, false, false)
...
func TestFeeParams(t *testing.T) {
	_, ctx, _, _, keeper := testComponents()
	oldFeeParamsBz := "7B22676C6F62616C5F6D696E696D756D5F6761735F707269636573223A5B7B2264656E6F6D223A2275687078222C22616D6F756E74223A22302E303130303030303030303030303030303030227D5D7D"
	...
	require.Equal(t, sdk.DecCoins{sdk.NewDecCoinFromDec("uhpx", sdk.NewDecWithPrec(1, 2))}, feeParams.GlobalMinimumGasPrices)
