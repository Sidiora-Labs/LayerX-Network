...
func init() {
	...
	goodConfig.EnabledLegacyPaxApis = evmrpc.PaxLegacyAllGatedMethodNames()
...
func generateTxData() {
	...
	EVMKeeper.SetAddressMapping(Ctx, paxAddr, evmAddr)
	...
	EVMKeeper.SetAddressMapping(
		Ctx,
		sdk.MustAccAddressFromBech32("pax1mf0llhmqane5w2y8uynmghmk2w4mh0xlwxuh3j"),
...
func buildTx(txData ethtypes.DynamicFeeTx) (client.TxBuilder, *ethtypes.Transaction) {
	...
	EVMKeeper.BankKeeper().AddCoins(Ctx, sdk.AccAddress(evmAddr[:]), sdk.NewCoins(sdk.NewCoin("uhpx", sdk.NewInt(10000000))), false)
...
func setupLogs() {
	...
	// Ante-failure stub receipt as written by modules/evm/keeper/abci.go's
...
//nolint:deadcode
func sendPaxRequestGood(t *testing.T, method string, params ...interface{}) map[string]interface{} {
	return sendPaxRequest(t, TestPort, method, params...)
}
...
func sendPaxRequest(t *testing.T, port int, method string, params ...interface{}) map[string]interface{} {
	return sendRequestWithNamespace(t, "pax", port, method, params...)
}
