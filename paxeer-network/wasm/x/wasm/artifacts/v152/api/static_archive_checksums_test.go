...
// checked into this package match the SHA256 sums published with the wasmd
// v0.3.6 release:
//
//	https://github.com/Paxeer-Network/paxeer-v3-matrix-release/releases/tag/v0.3.6
//
// These are the archives the cgo linker resolves `-lwasmvm152_muslc` against
// when building paxd with the `muslc` build tag (see link_muslc.go). Locking
