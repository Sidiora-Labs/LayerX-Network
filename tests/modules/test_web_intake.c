...
static const uint8_t web_signer_0[] = {
    0x2bU, 0x5aU, 0xd5U, 0xc4U, 0x79U, 0x5cU, 0x02U, 0x65U,
    0x14U, 0xf8U, 0x31U, 0x7cU, 0x7aU, 0x21U, 0x5eU, 0x21U,
    0x8dU, 0xccU, 0xd6U, 0xcfU
};

static const uint8_t web_signer_1[] = {
    0x68U, 0x13U, 0xebU, 0x93U, 0x62U, 0x37U, 0x2eU, 0xefU,
    0x62U, 0x00U, 0xf3U, 0xb1U, 0xdbU, 0xc3U, 0xf8U, 0x19U,
    0x67U, 0x1cU, 0xbaU, 0x69U
};

static const uint8_t web_signer_2[] = {
    0x7eU, 0x5fU, 0x45U, 0x52U, 0x09U, 0x1aU, 0x69U, 0x12U,
    0x5dU, 0x5dU, 0xfcU, 0xb7U, 0xb8U, 0xc2U, 0x65U, 0x90U,
    0x29U, 0x39U, 0x5bU, 0xdfU
};
...
static const uint8_t web_first_sig_0_high_s[] = {
    ...
    0xc2U, 0xa7U, 0xbaU, 0x4aU, 0xe8U, 0xfdU, 0x7cU, 0x47U,
    0x91U, 0x2fU, 0x86U, 0x36U, 0x14U, 0xbeU, 0x8cU, 0xafU,
    0xb4U, 0x03U, 0x6aU, 0xbeU, 0xccU, 0x65U, 0x7dU, 0xc1U,
    0x88U, 0xd5U, 0x59U, 0xa8U, 0x2fU, 0xffU, 0xe8U, 0x58U,
    0xcdU, 0xa2U, 0xa6U, 0x1aU, 0xa8U, 0xbdU, 0x47U, 0x5aU,
    0xbdU, 0xd2U, 0x3aU, 0xc1U, 0xa3U, 0x8aU, 0xc1U, 0x96U,
    0x1bU
};
