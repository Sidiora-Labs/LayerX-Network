...
int main(void)
{
    ...
    if (ctx_open() != 0 || position_state(1U, &position) != LXP_OK ||
        ...
        lx_perps_maintenance_check(&market, &position,
                                   ...
                                   market.price_scale, alice_margin_a->balance,
                                   &liquidatable) != LXP_OK || !liquidatable ||
        lx_perps_liquidation_fee_split((lxp_u128){ 0U, 100U }, 6000U,
                                       &liquidator_fee,
    ...
    if (ctx_open() != 0 || !balance_is(alice_margin_a, 0U) ||
        !balance_is(liquidity_account, 600U) ||
        ...
        deficit.amount.hi != 0U || deficit.amount.lo != 2400U ||
        memcmp(deficit.insurance_account_id, insurance_account->id,
               32U) != 0 ||
