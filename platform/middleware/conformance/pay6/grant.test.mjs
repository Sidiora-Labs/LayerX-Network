...
const offer = { scheme: "subscription", network: "layerx:testnet", asset: r.asset, amount: r.amount, payTo: r.to, maxTimeoutSeconds: 30, extra: { layerx: { commitment: "executed", purposeHash: r.payer_grant.purpose_hash, windowSeconds: "3600" } } };
