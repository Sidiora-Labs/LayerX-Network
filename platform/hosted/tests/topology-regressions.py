...
RESOLVED_EDGES = (
    ...
    'IngressController ingress-nginx/ingress-nginx -> layerx-testnet-public.layerx-testnet.svc:https [Ingress layerx-testnet/layerx-testnet-public layerx.network/]',
