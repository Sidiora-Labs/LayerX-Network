...
RESOLVED_EDGES = (
    ...
    'IngressController ingress-nginx/ingress-nginx -> layerx-testnet-public.layerx-testnet.svc:https [Ingress layerx-testnet/layerx-testnet-public beta.layerx.network/]',
    'IngressController ingress-nginx/ingress-nginx -> layerx-gateway.layerx-testnet.svc:https [Ingress layerx-testnet/layerx-gateway api.layerx.network/]',
