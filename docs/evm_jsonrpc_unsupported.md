...
This page is Paxeer Network RPC documentation inside [Sidiora-Labs/LayerX-Network](https://github.com/Sidiora-Labs/LayerX-Network) (chain sources at the repository root). It is not a standalone repository.
