...
Paxeer-LX-Network — una red: la cadena EVM de Paxeer y el dominio nativo de agentes LayerX bajo una sola interfaz.
...
Este repositorio es el monorepositorio de Sidiora Labs para Paxeer-LX-Network y Paxeer Network. La colocalización mantiene el protocolo, la red de liquidación, los contratos y las superficies de desarrollador auditables en un solo lugar. Cada subsistema conserva su propio límite de compilación, publicación, despliegue y confianza. Véase [`spec/layerx-protocol/design.md`](../../spec/layerx-protocol/design.md).
...
Paxeer-LX-Network lo desarrolla Sidiora Labs.
