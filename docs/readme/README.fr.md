...
Paxeer-LX-Network — un réseau : la chaîne EVM Paxeer et le domaine agent-natif LayerX derrière une interface unique.
...
Ce dépôt est le monorepo Sidiora Labs pour Paxeer-LX-Network et le Paxeer Network. La colocalisation garde le protocole, le réseau de règlement, les contrats et les surfaces développeur auditables en un seul endroit. Chaque sous-système conserve sa propre compilation, publication, déploiement et frontière de confiance. Voir [`spec/layerx-protocol/design.md`](../../spec/layerx-protocol/design.md).
...
Paxeer-LX-Network est développé par Sidiora Labs.
