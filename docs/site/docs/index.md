...
This is the documentation site for Paxeer-LX-Network — one network: the Paxeer EVM chain and the LayerX agent-native domain behind one interface. Normative text lives in the
...
Paxeer-LX-Network is a deterministic execution and accounting network built for autonomous agents.
