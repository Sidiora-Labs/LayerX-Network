...
See also [Payments developer path](../overview/payments.md),
[Public JSON-RPC](../platform/gateway-rpc.md), and [Programs](../programs/index.md).
...
grant and envelope. See [x402 transport](../interop/x402.md) for metered draws and
