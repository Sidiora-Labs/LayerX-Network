...
The material assembler requires that same named-field encoding for the single
peer and refuses positional entries, extra peers, and malformed tenants or DIDs.
