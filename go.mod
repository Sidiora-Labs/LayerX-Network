...
require (
	...
	github.com/paxeer-network/pax-load v0.0.1-pax.1
	github.com/paxeer-network/pax-tm-db v0.0.5-pax.1
	github.com/paxeer-network/pax-utils v0.0.2-pax.1
	github.com/paxeer-network/paxlog v0.0.3-pax.1
...
replace (
	...
	github.com/ethereum/go-ethereum => github.com/paxeer-network/pax-geth v1.15.7-pax.17
	...
	github.com/tendermint/tm-db => github.com/paxeer-network/pax-db-backend v0.0.4-pax.1
