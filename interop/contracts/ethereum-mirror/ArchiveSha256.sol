    ...
    function compress(bytes32 packed, bytes memory input, uint256 blocks) private pure returns (bytes32 result) {
        ...
        assembly ("memory-safe") {
            function transform(statePointer, wordPointer, constantPointer, blockPointer) {
                ...
                for { let roundBase := 0 } lt(roundBase, 64) { roundBase := add(roundBase, 16) } {
                    {
                        if roundBase {
                        ...
                        let first := and(add(add(add(h, xor(xor(or(shr(6, e), shl(26, e)), or(shr(11, e), shl(21, e))), or(shr(25, e), shl(7, e)))), xor(and(e, f), and(not(e), g))), add(and(shr(224, mload(add(constantPointer, add(mul(roundBase, 4), 0)))), 0xffffffff), mload(add(wordPointer, 0)))), 0xffffffff)
                    ...
                    }
                    {
                        ...
                        let first := and(add(add(add(g, xor(xor(or(shr(6, d), shl(26, d)), or(shr(11, d), shl(21, d))), or(shr(25, d), shl(7, d)))), xor(and(d, e), and(not(d), f))), add(and(shr(192, mload(add(constantPointer, add(mul(roundBase, 4), 0)))), 0xffffffff), mload(add(wordPointer, 32)))), 0xffffffff)
                    ...
                    }
                    {
                        ...
                        let first := and(add(add(add(f, xor(xor(or(shr(6, c), shl(26, c)), or(shr(11, c), shl(21, c))), or(shr(25, c), shl(7, c)))), xor(and(c, d), and(not(c), e))), add(and(shr(160, mload(add(constantPointer, add(mul(roundBase, 4), 0)))), 0xffffffff), mload(add(wordPointer, 64)))), 0xffffffff)
                    ...
                    }
                    {
                        ...
                        let first := and(add(add(add(e, xor(xor(or(shr(6, b), shl(26, b)), or(shr(11, b), shl(21, b))), or(shr(25, b), shl(7, b)))), xor(and(b, c), and(not(b), d))), add(and(shr(128, mload(add(constantPointer, add(mul(roundBase, 4), 0)))), 0xffffffff), mload(add(wordPointer, 96)))), 0xffffffff)
                    ...
                    }
                    {
                        ...
                        let first := and(add(add(add(d, xor(xor(or(shr(6, a), shl(26, a)), or(shr(11, a), shl(21, a))), or(shr(25, a), shl(7, a)))), xor(and(a, b), and(not(a), c))), add(and(shr(96, mload(add(constantPointer, add(mul(roundBase, 4), 0)))), 0xffffffff), mload(add(wordPointer, 128)))), 0xffffffff)
                    ...
                    }
                    {
                        ...
                        let first := and(add(add(add(c, xor(xor(or(shr(6, h), shl(26, h)), or(shr(11, h), shl(21, h))), or(shr(25, h), shl(7, h)))), xor(and(h, a), and(not(h), b))), add(and(shr(64, mload(add(constantPointer, add(mul(roundBase, 4), 0)))), 0xffffffff), mload(add(wordPointer, 160)))), 0xffffffff)
                    ...
                    }
                    {
                        ...
                        let first := and(add(add(add(b, xor(xor(or(shr(6, g), shl(26, g)), or(shr(11, g), shl(21, g))), or(shr(25, g), shl(7, g)))), xor(and(g, h), and(not(g), a))), add(and(shr(32, mload(add(constantPointer, add(mul(roundBase, 4), 0)))), 0xffffffff), mload(add(wordPointer, 192)))), 0xffffffff)
                    ...
                    }
                    {
                        ...
                        let first := and(add(add(add(a, xor(xor(or(shr(6, f), shl(26, f)), or(shr(11, f), shl(21, f))), or(shr(25, f), shl(7, f)))), xor(and(f, g), and(not(f), h))), add(and(shr(0, mload(add(constantPointer, add(mul(roundBase, 4), 0)))), 0xffffffff), mload(add(wordPointer, 224)))), 0xffffffff)
                    ...
                    }
                    {
                        ...
                        let first := and(add(add(add(h, xor(xor(or(shr(6, e), shl(26, e)), or(shr(11, e), shl(21, e))), or(shr(25, e), shl(7, e)))), xor(and(e, f), and(not(e), g))), add(and(shr(224, mload(add(constantPointer, add(mul(roundBase, 4), 32)))), 0xffffffff), mload(add(wordPointer, 256)))), 0xffffffff)
                        let second := and(add(xor(xor(or(shr(2, a), shl(30, a)), or(shr(13, a), shl(19, a))), or(shr(22, a), shl(10, a))), xor(xor(and(a, b), and(a, c)), and(b, c))), 0xffffffff)
                        d := and(add(d, first), 0xffffffff)
                        h := and(add(first, second), 0xffffffff)
                    }
                    {
                        ...
                        let first := and(add(add(add(g, xor(xor(or(shr(6, d), shl(26, d)), or(shr(11, d), shl(21, d))), or(shr(25, d), shl(7, d)))), xor(and(d, e), and(not(d), f))), add(and(shr(192, mload(add(constantPointer, add(mul(roundBase, 4), 32)))), 0xffffffff), mload(add(wordPointer, 288)))), 0xffffffff)
                        let second := and(add(xor(xor(or(shr(2, h), shl(30, h)), or(shr(13, h), shl(19, h))), or(shr(22, h), shl(10, h))), xor(xor(and(h, a), and(h, b)), and(a, b))), 0xffffffff)
                        c := and(add(c, first), 0xffffffff)
                        g := and(add(first, second), 0xffffffff)
                    }
                    {
                        ...
                        let first := and(add(add(add(f, xor(xor(or(shr(6, c), shl(26, c)), or(shr(11, c), shl(21, c))), or(shr(25, c), shl(7, c)))), xor(and(c, d), and(not(c), e))), add(and(shr(160, mload(add(constantPointer, add(mul(roundBase, 4), 32)))), 0xffffffff), mload(add(wordPointer, 320)))), 0xffffffff)
                        let second := and(add(xor(xor(or(shr(2, g), shl(30, g)), or(shr(13, g), shl(19, g))), or(shr(22, g), shl(10, g))), xor(xor(and(g, h), and(g, a)), and(h, a))), 0xffffffff)
                        b := and(add(b, first), 0xffffffff)
                        f := and(add(first, second), 0xffffffff)
                    }
                    {
                        ...
                        let first := and(add(add(add(e, xor(xor(or(shr(6, b), shl(26, b)), or(shr(11, b), shl(21, b))), or(shr(25, b), shl(7, b)))), xor(and(b, c), and(not(b), d))), add(and(shr(128, mload(add(constantPointer, add(mul(roundBase, 4), 32)))), 0xffffffff), mload(add(wordPointer, 352)))), 0xffffffff)
                        let second := and(add(xor(xor(or(shr(2, f), shl(30, f)), or(shr(13, f), shl(19, f))), or(shr(22, f), shl(10, f))), xor(xor(and(f, g), and(f, h)), and(g, h))), 0xffffffff)
                        a := and(add(a, first), 0xffffffff)
                        e := and(add(first, second), 0xffffffff)
                    }
                    {
                        ...
                        let first := and(add(add(add(d, xor(xor(or(shr(6, a), shl(26, a)), or(shr(11, a), shl(21, a))), or(shr(25, a), shl(7, a)))), xor(and(a, b), and(not(a), c))), add(and(shr(96, mload(add(constantPointer, add(mul(roundBase, 4), 32)))), 0xffffffff), mload(add(wordPointer, 384)))), 0xffffffff)
                        let second := and(add(xor(xor(or(shr(2, e), shl(30, e)), or(shr(13, e), shl(19, e))), or(shr(22, e), shl(10, e))), xor(xor(and(e, f), and(e, g)), and(f, g))), 0xffffffff)
                        h := and(add(h, first), 0xffffffff)
                        d := and(add(first, second), 0xffffffff)
                    }
                    {
                        ...
                        let first := and(add(add(add(c, xor(xor(or(shr(6, h), shl(26, h)), or(shr(11, h), shl(21, h))), or(shr(25, h), shl(7, h)))), xor(and(h, a), and(not(h), b))), add(and(shr(64, mload(add(constantPointer, add(mul(roundBase, 4), 32)))), 0xffffffff), mload(add(wordPointer, 416)))), 0xffffffff)
                        let second := and(add(xor(xor(or(shr(2, d), shl(30, d)), or(shr(13, d), shl(19, d))), or(shr(22, d), shl(10, d))), xor(xor(and(d, e), and(d, f)), and(e, f))), 0xffffffff)
                        g := and(add(g, first), 0xffffffff)
                        c := and(add(first, second), 0xffffffff)
                    }
                    {
                        ...
                        let first := and(add(add(add(b, xor(xor(or(shr(6, g), shl(26, g)), or(shr(11, g), shl(21, g))), or(shr(25, g), shl(7, g)))), xor(and(g, h), and(not(g), a))), add(and(shr(32, mload(add(constantPointer, add(mul(roundBase, 4), 32)))), 0xffffffff), mload(add(wordPointer, 448)))), 0xffffffff)
                        let second := and(add(xor(xor(or(shr(2, c), shl(30, c)), or(shr(13, c), shl(19, c))), or(shr(22, c), shl(10, c))), xor(xor(and(c, d), and(c, e)), and(d, e))), 0xffffffff)
                        f := and(add(f, first), 0xffffffff)
                        b := and(add(first, second), 0xffffffff)
                    }
                    {
                        ...
                        let first := and(add(add(add(a, xor(xor(or(shr(6, f), shl(26, f)), or(shr(11, f), shl(21, f))), or(shr(25, f), shl(7, f)))), xor(and(f, g), and(not(f), h))), add(and(shr(0, mload(add(constantPointer, add(mul(roundBase, 4), 32)))), 0xffffffff), mload(add(wordPointer, 480)))), 0xffffffff)
                        let second := and(add(xor(xor(or(shr(2, b), shl(30, b)), or(shr(13, b), shl(19, b))), or(shr(22, b), shl(10, b))), xor(xor(and(b, c), and(b, d)), and(c, d))), 0xffffffff)
                        e := and(add(e, first), 0xffffffff)
                        a := and(add(first, second), 0xffffffff)
                    }
