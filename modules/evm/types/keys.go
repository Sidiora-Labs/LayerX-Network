...
var (
	EVMAddressToPaxAddressKeyPrefix            = []byte{0x01}
	PaxAddressToEVMAddressKeyPrefix            = []byte{0x02}
...
func EVMAddressToPaxAddressKey(evmAddress common.Address) []byte {
	return append(EVMAddressToPaxAddressKeyPrefix, evmAddress[:]...)
}
