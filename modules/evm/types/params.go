...
var (
	...
	KeyPaxSstoreSetGasEIP2200              = []byte("KeyPaxSstoreSetGasEIP2200")
	// deprecated
...
// DefaultBaseFeePerGas determines how much uhpx per gas spent is
...
var DefaultPaxSstoreSetGasEIP2200 = uint64(20000) // 20k
...
func DefaultParams() Params {
	return Params{
		...
		PaxSstoreSetGasEip2200:                 DefaultPaxSstoreSetGasEIP2200,
	}
}
...
func (p *Params) ParamSetPairs() paramtypes.ParamSetPairs {
	return paramtypes.ParamSetPairs{
		...
		paramtypes.NewParamSetPair(KeyPaxSstoreSetGasEIP2200, &p.PaxSstoreSetGasEip2200, validatePaxSstoreSetGasEIP2200),
...
func (p Params) Validate() error {
	...
	if err := validatePaxSstoreSetGasEIP2200(p.PaxSstoreSetGasEip2200); err != nil {
		return fmt.Errorf("invalid pax sstore set gas eip2200: %s", err)
	}
	return nil
}
...
func validatePaxSstoreSetGasEIP2200(i interface{}) error {
	v, ok := i.(uint64)
	if !ok {
		return fmt.Errorf("invalid parameter type: %T", i)
	}
	if v == 0 {
		return fmt.Errorf("invalid pax sstore set gas eip2200: must be greater than 0, got %d", v)
	}
	return nil
}
